...
const POSTS = [
  ...
  },
  {
    ...
    posterH: 'Give your agent hands',
    deck: 'Model Context Protocol without the spec-reading. One server, three tools, and a working connection to a real client.',
    category: 'Agents',
    date: '2026-08-07',
    mins: 16,
    num: '02',
    author: AUTHOR,
    tags: ['mcp', 'protocol', 'tools', 'server', 'stdio'],
    draft: true
  },
  {
  ...
  {
    slug: 'subagents-in-practice',
    type: 'tutorial',
    title: 'Subagents in practice: when parallel beats sequential',
    posterH: 'Ten agents, one answer',
    deck: 'Fan-out is seductive and usually wrong. Here are the four shapes of work where it genuinely pays, with the configs.',
    category: 'Agents',
    date: '2026-07-15',
    mins: 13,
    num: '03',
    author: AUTHOR,
    tags: ['subagents', 'parallel', 'orchestration', 'fan-out'],
    draft: true
  },
  {
  ...
  },
  {
    ...
    type: 'tutorial',
    title: 'Writing a CLAUDE.md your agent will actually obey',
    posterH: 'Rules that survive contact',
    deck: 'Most instruction files are wish lists. The ones that work are short, testable, and written like a lint config.',
    category: 'Workflow',
    date: '2026-07-01',
    mins: 7,
    num: '04',
    author: AUTHOR,
    tags: ['claude.md', 'agents.md', 'instructions', 'memory', 'prompting'],
    draft: true
  }
];
